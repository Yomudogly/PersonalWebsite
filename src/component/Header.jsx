...
const SocialShare = [
    ...
    {Social: <FaTelegram /> , link: 'https://telegram.me/khalnepes'}
]
class Header extends Component{
    ...
    render(){
        ...
        let logoUrl = <img src="/assets/images/logo/logo-symbol-dark.png"/>;
                ...
                <div className="header-wrapper">
                    <div className="header-left d-flex align-items-center">
                        ...
                        <nav className="mainmenunav d-lg-block ml--50">
                            <Scrollspy className="mainmenu" items={['home','about','skills','portfolio','numbers','contact']} currentClassName="is-current" offset={-200}>
